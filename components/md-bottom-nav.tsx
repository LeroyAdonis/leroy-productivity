...
export default function MdBottomNav() {
  ...
  return (
    <nav className="md-bottom-nav" aria-label="Primary">
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={`md-bottom-nav-item ${isActive ? 'md-bottom-nav-item-active' : ''}`}
              aria-label={item.label}
              aria-current={isActive ? 'page' : undefined}
            >
              <div
                className={`md-bottom-nav-indicator ${isActive ? 'md-bottom-nav-indicator-active' : ''}`}
              >
                {item.icon}
              </div>
