...
export const schemaSql = `
  ...
  -- Seed initial data
  INSERT INTO users (id, name, theme) VALUES (1, 'Leroy Adonis', 'dark');

  INSERT INTO daily_routines (id, user_id, name, sort_order) VALUES
    (1, 1, 'Morning Routine', 0),
    (2, 1, 'Evening Routine', 1);

  INSERT INTO routine_steps (id, routine_id, step_text, estimated_minutes, sort_order) VALUES
